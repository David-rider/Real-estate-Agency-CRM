...
router.post('/checkout', authenticateToken, async (req: any, res) => {
    try {
        ...
        let amountForPlan = 0;
        switch (planId) {
            case 'PRO_MONTHLY': amountForPlan = 3900; break;
            case 'PRO_ANNUAL': amountForPlan = 39000; break;
            case 'ELITE_MONTHLY': amountForPlan = 7900; break;
            case 'ELITE_ANNUAL': amountForPlan = 79000; break;
            default:
