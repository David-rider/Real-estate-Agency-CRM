...
export default function LoginPage() {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'apple') => {
    setIsLoading(true);
    try {
      // In a real application, this would trigger the OAuth popup (e.g. Firebase, Google Identity Services)
      // Here we simulate a successful OAuth callback resolving to our backend endpoints
