      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center p-8 lg:p-24 border-r border-border animate-in fade-in slide-in-from-left-8 duration-700">
        <div className="max-w-md w-full mx-auto">
          <div className="mb-12">
            ...
            <p className="font-sans text-base tracking-wide text-foreground/50 border-l-2 border-primary/50 pl-4">
              {t.signup.subtitle}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-primary text-background rounded-none text-base uppercase tracking-widest font-medium transition-all hover:bg-primary-hover disabled:opacity-50 flex items-center justify-center gap-3 group mt-8"
            >
              {isLoading ? (
